...
int numeroCaracteres(FILE* fp_in, int* posicao);
void atualizaPosicao(FILE* fp_in, int* posicao);
int logicaMain(FILE* fp_in, FILE* fp_out, char* token, int* contStart, int* elementos, int** matrizSoma, int* tam, int* tamLinhas, int* numero, int* contLoop, int* posicao);
